            ...
            <div className=" container-fluid container-fixed-lg sm-p-l-0 sm-p-r-0">
                <div className="inner">
                    <ol className="breadcrumb">
                        ...
                        <li className="breadcrumb-item active">Spaces</li>
                    </ol>
                </div>
            </div>
               ...
               <div className="m-0 row card-block">
                  ...
                  <div className="card social-card share m-3 col1" data-social="item">
                     ...
                     <div className="card-content">
                        <ul className="buttons ">
                           <li>
                              <Link to={{ pathname: '/spaces/1' }}><i className="fa fa-expand"></i></Link>
                           </li>
                           <li>
                  ...
                  <div className="card social-card share m-3 col1" data-social="item">
                     ...
                     <div className="card-content">
                        <ul className="buttons ">
                           <li>
                              <Link to={{ pathname: '/spaces/2' }}><i className="fa fa-expand"></i></Link>
                           </li>
                           <li>
                              <a href="#"><i className="fa fa-heart-o"></i>
                              </a>
